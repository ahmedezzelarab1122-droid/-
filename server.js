...
const EMAIL_PASS = process.env.EMAIL_PASS || 'vervgkrdmdgxeemi';
...
2. type=tax إذا كان الرقم الضريبي للعميل (المشتري) هو '311305757400003'، وإلا type=petty. استخرج الرقم الضريبي للعميل في حقل customerTaxId
